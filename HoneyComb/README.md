...
**▶ [플레이하기](https://jinsikhan.github.io/HoneyComb/HoneyComb.html)**
...
HoneyComb는 **벌집 세계관**을 바탕으로 단순 퍼즐을 넘어, 스토리와 규칙을 점차 확장해 나갈 예정입니다.  
새 구역, 새 블록, 새 목표를 더해 하나의 퍼즐 게임이 **하나의 세계**로 성장하도록 계속 발전시킬 예정입니다.
