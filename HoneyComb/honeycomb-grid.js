...
(function (G) {
  ...
  G.maxDiamondsOnGrid = function () {
    // lv1~4: 4, lv5~9: 5, lv10~14: 6 ... 점진 증가 (상한 14)
    return Math.min(14, 4 + Math.floor(Math.max(0, G.level - 1) / 5));
  };
  function diamondChanceForLevel(lv) {
    // lv1≈0.225, lv12≈0.28, lv30≈0.37에서 캡
    return Math.min(0.37, 0.22 + lv * 0.005);
  }
